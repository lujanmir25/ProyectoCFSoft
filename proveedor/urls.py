...
# Local
from .views import OrdenView, ProveedorView, ProveedorNew, ProveedorEdit, ProveedorDel, clienteInactivar,\
    ComprasView, OrdenComprasView ,compras, CompraDetDelete, orden_compras
...
urlpatterns = [
    ...
    path('orden_compra/estado_c/<int:id>',clienteInactivar, name="cliente_inactivar"),
